...
#Process
# provide this function a policy ID
# for each block get list of violations from most recent violations report
# for each resource tag key:CH_Automated_Savings Value: YYYY-MM


#Variables
api_key = os.environ.get('api_key') # this key can be gotten from the user account settings page
policy_id = os.environ.get('policy_id') # this id can be gotten either from the URL of the policy or via the policies API
